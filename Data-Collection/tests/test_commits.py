...
class Test_Commits(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.dbConnector.executeSQL(
            sql="CREATE TABLE Commits (ID INTEGER, SHA TEXT, Branch TEXT, Author TEXT, Commit_Date TEXT, Tree_SHA TEXT, Comment_Count INTEGER, PRIMARY KEY(ID));"
        )
        ...
        cls.dataComparison = [
            (0, "testSHA", "sha", "testName", "testDate", "testTreeSHA", 7357)
        ]
