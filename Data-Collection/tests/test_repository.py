...
class Test_Repository(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.dbConnector.executeSQL(
            sql="CREATE TABLE Repository (ID INTEGER, Name TEXT, Owner TEXT, Private TEXT, Fork TEXT, Created_At TEXT, Updated_At TEXT, Pushed_At TEXT, Size INTEGER, Forks INTEGER, Open_Issues INTEGER, PRIMARY KEY(ID))"
        )
